    ...
    <div class="row">
        ...
        <div class="col-4">
            <main class="form-signin" style="padding: 0px 40px">
                <form action="php/cadastro.php" method="post" class="card-body p-12" style="margin-top: 8%;">
                    ...
                    <br><button class="w-100 btn btn-lg btn-primary" type="submit">Cadastrar</button>

                </form>

                <div class="checkbox mb-3" style="margin-top: 20px;">
                    <a href="index.php"><p class="">Já sou cadastrado!</p></a>
                </div>
