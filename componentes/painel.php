    ...
    <div class="container px-4 py-4" id="featured-3">
        <div class="row g-4 py-3 row-cols-1 row-cols-lg-3">
            <div class="feature col">
                <div class="feature-icon bg-primary bg-gradient" style="width: 80px; padding: 15px 0px; border-radius: 20px; background-color: #6e18a0;">
        ...
        <div class="row g-4 py-3 row-cols-1 row-cols-lg-3">
            <div class="feature col background-color: #6e18a0;">
